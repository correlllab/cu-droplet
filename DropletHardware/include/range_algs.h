...
#define POST_MESSAGE_DELAY ((1000/IR_UPKEEP_FREQUENCY)+5)

#define NUMBER_OF_RB_MEASUREMENTS 6
#define NUMBER_PRE_MEASUREMENTS 0
#define NUMBER_POST_MEASUREMENTS 0
