...
uint8_t get_droplet_ord(uint16_t id)
{
	switch(id)
	{
		...
		case 0x2B4E: return 100;	//This is the first AUDIO_DROPLET
		case 0x7D78: return 101;
		case 0x8B46: return 102;
		case 0xC806: return 103;
		case 0x4177: return 104;
		case 0x0A0B: return 105;
		case 0x3B49: return 106;
		case 0x028C: return 107;
		case 0x1F08: return 108;
		case 0xEEB0: return 109;
		case 0xA649: return 110;
		case 0xA5B5: return 111;
		case 0xF60A: return 112;
		case 0xB944: return 113;
		case 0x3405: return 114;
		case 0x43BA: return 115;
		case 0x6648: return 116;
		case 0x1B4B: return 117;
		case 0xC24B: return 118;
		case 0x4DB0: return 119;
	}
	return 0xFF;
}