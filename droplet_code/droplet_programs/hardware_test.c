...
void state_changed_printout()
{
	switch(state)
	{
		case MIC_TEST:
			...
			#else
				printf("This Droplet doesn't have a mic! Nothing to see here.\r\n");
			#endif				
			return 1;
		case IR_IO_TEST:
		...
		case MOTOR_TEST:
			...
			motor_adjusts[0][1]=2000;
			motor_adjusts[0][2]=0;
			motor_adjusts[1][1]=0;
			motor_adjusts[1][2]=2000;
			motor_adjusts[2][1]=-2000;
			motor_adjusts[2][2]=0;	
			motor_adjusts[3][1]=0;
			motor_adjusts[3][2]=-2000;
			motor_adjusts[4][1]=2000;
			motor_adjusts[4][2]=2000;
			motor_adjusts[5][1]=-2000;
			motor_adjusts[5][2]=-2000;
			moving_dir=0;
			return 1;	
		case SPEAKER_TEST:
