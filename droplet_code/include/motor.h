...
static inline void motor_forward(uint8_t num)
{
	switch(num)
	{
		...
		//case 2: TCD0.CTRLB = TC_WGMODE_SS_gc | TC0_CCBEN_bm; PORTD.PIN1CTRL = PORT_INVEN_bm; PORTD.OUTSET |= PIN0_bm; break; //AUDIO_DROPLET
	}
}
...
static inline void motor_backward(uint8_t num)
{
	switch(num)
	{
		...
		//case 2: TCD0.CTRLB = TC_WGMODE_SS_gc | TC0_CCAEN_bm; PORTD.PIN0CTRL = PORT_INVEN_bm; PORTD.OUTSET |= PIN1_bm; break; //AUDIO_DROPLET
	}
}
