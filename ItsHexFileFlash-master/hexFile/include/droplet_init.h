...
// NOTE: I am trying to make user_template.c as empty as poosible
...
void		init() __attribute__ ((section (".USERCODE")));
void		loop();// __attribute__ ((section (".BOOT")));
void		handle_msg			(ir_msg* msg_struct);// __attribute__ ((section (".BOOT")));
