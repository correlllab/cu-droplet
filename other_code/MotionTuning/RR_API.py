#NOTE - this is an example of implementing the RAW socket messaging
#				for the RoboRealm API. We *strongly* recommend using the 
# 			COM version instead (example included next to this file) as
#				the COM object has all functions implemented. This file is 
#				provided as a reference for use in non-Windows systems.
