...
#define FFSYNC_FULL_PERIOD_MS		4000
#define FFSYNC_REFR_PERIOD_MS		300
#define FFSYNC_TRANSMIT_DELAY_MS	16

#define FFSYNC_FULL_PERIOD			(uint16_t)(FFSYNC_FULL_PERIOD_MS*7.8125)
#define FFSYNC_REFR_PERIOD			(uint16_t)(FFSYNC_REFR_PERIOD_MS*7.8125)

#define FFSYNC_TRANSMIT_DELAY		(uint16_t)(FFSYNC_TRANSMIT_DELAY_MS*7.8125)
#define FIREFLY_SYNC_WAIT_TIME		(FFSYNC_FULL_PERIOD-FFSYNC_TRANSMIT_DELAY)
